...
public class FolioActivity
    ...
    public void startContentHighlightActivity() {
        ...
        intent.putExtra(Constants.PUBLICATION, String.valueOf(pubBox.getPublication()));
        try {
    ...
    public void onBookInitSuccess() {
        ...
        if (mBookId == null) {
            if (!publication.getMetadata().getIdentifier().isEmpty()) {
                mBookId = publication.getMetadata().getIdentifier();
            } else {
