...
class MediaControllerFragment : BottomSheetDialogFragment() {
    ...
    private fun initColors() {
        ...
        btn_half_speed?.setTextColor(
            UiUtil.getColorList(
                config.themeColor,
                ContextCompat.getColor(context!!, R.color.grey_color)
            )
        )
        btn_one_and_half_speed?.setTextColor(
            UiUtil.getColorList(
                config.themeColor,
                ContextCompat.getColor(context!!, R.color.grey_color)
            )
        )
        btn_twox_speed?.setTextColor(
            UiUtil.getColorList(
                config.themeColor,
                ContextCompat.getColor(context!!, R.color.grey_color)
            )
        )
        btn_one_x_speed?.setTextColor(
            UiUtil.getColorList(
                config.themeColor,
                ContextCompat.getColor(context!!, R.color.grey_color)
            )
        )
        btn_text_undeline_style?.setTextColor(
            UiUtil.getColorList(
                config.themeColor,
                ContextCompat.getColor(context!!, R.color.grey_color)
            )
        )
        btn_backcolor_style?.setTextColor(
            UiUtil.getColorList(
        ...
        btn_backcolor_style?.setBackgroundDrawable(
            UiUtil.createStateDrawable(
                config.themeColor,
                ContextCompat.getColor(context!!, android.R.color.transparent)
            )
        )
        btn_text_color_style?.setTextColor(
            UiUtil.getColorList(
                config.themeColor,
                ContextCompat.getColor(context!!, R.color.grey_color)
            )
