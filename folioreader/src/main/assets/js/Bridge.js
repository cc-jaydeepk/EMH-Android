...
function setMediaOverlayStyleColors(color, colorHighlight) {
   ...
   stylesheet.insertRule(".mediaOverlayStyle2 span.epub-media-overlay-playing { color: "+color+" !important }")*/
    stylesheet.insertRule(".mediaOverlayStyle0 span.epub-media-overlay-playing { background: #820b0c !important }")
    stylesheet.insertRule(".mediaOverlayStyle1 span.epub-media-overlay-playing { border-color: #820b0c !important }")
    stylesheet.insertRule(".mediaOverlayStyle2 span.epub-media-overlay-playing { color: #820b0c !important }")
}
